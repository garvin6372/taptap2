...
return [
    ...
    */
    'bots' => [
        'mybot' => [
            'token' => env('TELEGRAM_BOT_TOKEN', '7510331040:AAGCuJxeGUhM5trIIP4AuZr_j4Cvy_vvbg0'),
            'certificate_path' => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url' => env('TELEGRAM_WEBHOOK_URL', 'https://webhook.site/44540e18-66ba-44fb-9784-6b9e5cc72255'),
            /*
